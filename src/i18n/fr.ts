...
export const fr: Dict = {
    ...
    teamPage: {
        ...
        values: [
            { n: "01", title: "Écouter d'abord", body: "Avant la coupe vient la conversation. Comprendre comment vous vivez, ce que vous faites, le temps que vous consacrez le matin — tout entre dans le résultat final." },
            { n: "02", title: "Vraie technique", body: "Ciseaux, rasoir, tondeuse, ciseaux sur peigne, texturisation. Chaque outil sert un résultat précis. On ne choisit pas par habitude : on choisit pour la coupe." },
            { n: "03", title: "Continuité", body: "Votre barbier vous connaît. Il sait comment s'est passée la dernière coupe, ce que vous avez aimé et ce que vous n'avez pas aimé. C'est un service construit dans le temps, pas une simple transaction." },
        ],
    },
    lavoriPage: {
        featuredBadge: "Travail du mois",
        featuredSubtitle: "Mai 2026",
        featuredTitle: "Razor cut avec dégradé progressif",
        featuredBody: "Un client habituel, vu deux semaines avant pour fixer une direction : moins de volume sur les côtés, plus de texture sur le dessus. Travail au rasoir sur les pointes pour adoucir la chute naturelle, fade à la nuque pour la netteté. Résultat : coiffable en 30 secondes le matin, sans produit.",
        featuredMeta: [
            { label: "Master barber", value: "Federico Asara" },
            { label: "Durée", value: "55 minutes" },
            { label: "Technique", value: "Razor + Fade" },
            { label: "Entretien", value: "Toutes les 3 semaines" },
        ],
    },
    productsPage: {
        faqEyebrow: "Comment ça marche",
        faqTitle: "Paiement et retrait, simple.",
        faq: [
            { q: "Puis-je payer en ligne ?", a: "Non, par choix. Vous réservez les produits en ligne et payez au salon au retrait — espèces ou carte. C'est notre façon de gérer un petit commerce : sans intermédiaire de paiement et avec un bonjour de plus au client." },
            { q: "Combien de temps ai-je pour retirer ?", a: "Sept jours après la commande. Vous recevrez un code court (ex. \"7HZ3K9\") à montrer au barbier, et en deux secondes on prend vos produits en stock. Si vous ne pouvez pas dans la semaine, écrivez-nous, on le garde au chaud." },
    ...
    contactPage: {
        ...
        heroTitleA: "Parlons-en",
        heroTitleB: "directement",
        heroIntro: "Téléphone ou email — réponse sous une heure ouvrée. Ou passez directement au Via Regina Elena 33/A.",
        heroMetaLeft: "Réponse · 1h ouvrée",
        heroMetaRight: "05 / Contact",
        chipCall: "Appeler",
        chipEmail: "Email",
        chipDirections: "Itinéraire",
        bookEyebrow: "Envie de réserver ?",
        bookTitle: "La réservation est le plus rapide.",
        bookBody: "Choisissez service, barbier et horaire en 60 secondes. Confirmation immédiate, zéro appel. Si vous préférez quand même nous joindre, les coordonnées ci-dessus sont actives aux heures d'ouverture.",
        recapitiEyebrow: "Coordonnées",
        recapitiTitle: "Comment nous joindre.",
        phoneLabel: "Téléphone",
        phoneHint: "Disponibles aux heures d'ouverture.",
        emailLabel: "Email",
        emailHint: "Réponse sous une heure ouvrée.",
        salonLabel: "Salon",
        mapBtn: "Ouvrir dans Maps",
        formEyebrow: "Travailler avec nous",
        formTitle: "Partenariats, presse, propositions.",
        formBody: "Ce formulaire est dédié aux partenariats, rédactions, marques et fournisseurs. Pour réserver une coupe, utilisez le bouton de réservation ci-dessus ou appelez-nous.",
        formBookLink: "Pour réserver une coupe",
        formCallLink: "appelez-nous",
    },
    notFound: {
        eyebrow: "404",
