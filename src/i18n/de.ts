...
export const de: Dict = {
    ...
    reviews: {
        ...
        items: [
            {
                name: "Alessandro M.",
                text: "Der beste Barbier in Olbia, ohne Zweifel. Marco hat unglaubliches Talent für Fades — er hört wirklich zu und schlägt maßgeschneiderte Lösungen vor. Ich komme jeden Monat wieder.",
                date: "April 2025",
                location: "Olbia",
            },
            {
            ...
            {
                name: "Giovanni P.",
                text: "Endlich ein Ort, an dem man wirklich zuhört. Ich habe ein Foto gezeigt und das Ergebnis war noch besser. Sehr empfehlenswert für alle, die maßgeschneiderte Qualität suchen.",
                date: "Februar 2025",
                location: "Sassari",
            },
            {
                name: "Luigi B.",
                text: "Die Liebe zum Detail ist beeindruckend. Vom Waschen bis zum Finish ist jeder Handgriff durchdacht. Der Schnitt hält wirklich einen Monat und lässt sich perfekt stylen.",
                date: "Januar 2025",
                location: "Olbia",
            },
        ],
    ...
    booking: {
        ...
        titleB: "Style.",
        intro:
            "Wähle Service, Barber und Zeit. Wenige Schritte, kein Telefon-Warten. Bestätigung per WhatsApp.",
    ...
    badges: {
        rating: "★ 4.9 · 247 Google-Bewertungen",
            ...
            toggles: [
                {
                    ...
                    description: "Erhalte Angebote, Produkt-Previews und Neuigkeiten per E-Mail/WhatsApp",
                },
                {
            ...
            steps: [
                {
                    n: "01",
                    title: "Code teilen",
                    body: "Sende deinen Code oder Link an Freunde, per WhatsApp oder E-Mail.",
                },
                {
                    n: "02",
                    title: "Freund bucht",
