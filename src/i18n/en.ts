...
export const en: Dict = {
    ...
    teamPage: {
        ...
        values: [
            { n: "01", title: "Listen first", body: "Before the cut comes the conversation. Understanding how you live, what you do, how much time you give your hair in the morning — it all goes into the final result." },
            { n: "02", title: "Real technique", body: "Scissors, razor, clippers, scissor-over-comb, texturing. Every tool serves a precise result. We don't choose out of habit: we choose for the cut." },
            { n: "03", title: "Continuity", body: "Your barber knows you. They know how the last cut went, what you liked and what you didn't. It's a service built over time, not a one-off transaction." },
        ],
    },
    lavoriPage: {
        featuredBadge: "Work of the month",
        featuredSubtitle: "May 2026",
        featuredTitle: "Razor cut with graduated fade",
        featuredBody: "A regular client, seen two weeks earlier to set a direction: less volume on the sides, more texture on top. Razor-worked on the ends to soften the natural fall, fade at the nape for cleanliness. Result: combable in 30 seconds in the morning, no product.",
        featuredMeta: [
            { label: "Master barber", value: "Federico Asara" },
            { label: "Time", value: "55 minutes" },
            { label: "Technique", value: "Razor + Fade" },
            { label: "Upkeep", value: "Every 3 weeks" },
        ],
    },
    productsPage: {
        faqEyebrow: "How it works",
        faqTitle: "Payment and pickup, simple.",
        faq: [
            { q: "Can I pay online?", a: "No, by choice. You reserve the products online and pay at the salon on pickup — cash or card. It's how we like to run a small retail: no payment middlemen and one more greeting for the client." },
            { q: "How long do I have to pick up?", a: "Seven days from the order. You'll get a short code (e.g. \"7HZ3K9\") to show the barber, and in two seconds we grab your products from stock. If you can't make it within the week, write us and we'll keep it aside." },
            { q: "Can I try a product before buying it?", a: "Yes, at the salon we have open testers for pomades, waxes and oils. Drop by and feel the texture in your hand. We don't sell anything blind." },
            { q: "What if a product isn't right for me?", a: "You have 14 days to swap it or get a voucher of equal value. We replace it directly at the salon — nothing to ship back." },
        ],
        merch: {
            chip: "Limited edition · salon only",
            titleA: "Official merch",
            body: "Hair Rich branded T-shirts, hoodies and caps. No online catalogue, limited pieces. Call us to find out what we have, sizes and colours — drop by the salon to collect.",
            facts: [
                { v: "Limited", l: "Exclusive drops" },
                { v: "100%", l: "Premium cotton" },
                { v: "Olbia", l: "Salon only" },
            ],
            cta: "Call to request",
            footer: "Available during opening hours",
        },
    ...
    contactPage: {
        ...
        heroTitleA: "Let's talk",
        heroTitleB: "directly",
        heroIntro: "Phone or email — reply within one working hour. Or just drop by at Via Regina Elena 33/A.",
        heroMetaLeft: "Reply · 1 working hour",
        heroMetaRight: "05 / Contact",
        chipCall: "Call",
        chipEmail: "Email",
        chipDirections: "Directions",
        bookEyebrow: "Want to book?",
        bookTitle: "Booking is the fastest way.",
        bookBody: "Pick service, barber and time in 60 seconds. Instant confirmation, zero phone calls. If you'd still rather reach us, the details above are live during opening hours.",
        recapitiEyebrow: "Details",
        recapitiTitle: "How to reach us.",
        phoneLabel: "Phone",
        phoneHint: "Available during opening hours.",
        emailLabel: "Email",
        emailHint: "Reply within one working hour.",
        salonLabel: "Salon",
        mapBtn: "Open in Maps",
        formEyebrow: "Work with us",
        formTitle: "Partnerships, press, proposals.",
        formBody: "This form is for partnerships, editorial, brands and suppliers. To book a haircut, use the booking button above or call us.",
        formBookLink: "To book a haircut",
        formCallLink: "call us",
    },
    notFound: {
        eyebrow: "404",
