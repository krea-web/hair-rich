...
// Icone per le 3 modalità (a piedi / auto / aeroporto). Il testo è localizzato
// via i18n (t.directions.routes), abbinato per indice.
...
export function GettingHere() {
    ...
    const ROUTES = d.routes.map((r, i) => ({ ...r, icon: ICONS[i] }));
    return (
                ...
                <div className="mb-12 md:mb-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-end">
                    <div>
                        ...
                        <h2 className="text-display text-3xl md:text-5xl text-warm-white tracking-tight mt-4 leading-[1.05]">
                            {d.addressLine}<br />
                            <em className="text-display-alt not-italic text-silver">{d.city}</em>
                        </h2>
                    </div>
