...
export function InstagramSection() {
    ...
    return (
        <section
            ...
            className="relative py-12 md:py-16 lg:py-20 xl:py-24 2xl:py-28 px-6 md:px-12 lg:px-16 xl:px-20 2xl:px-24 bg-black-2 overflow-hidden border-y border-line"
        >
            {/* Editorial watermark */}
            <div
                aria-hidden="true"
